 ...
 *   - hasTodosOnDate: 선택된 날짜에 Todo 존재 여부
 ...
 */
function TodoList({ todos, activeFilter, hasTodosOnDate, onToggleComplete, onUpdateText, onDelete }) {
  if (!hasTodosOnDate) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <p className="text-sm text-gray-400">이 날짜에 할 일이 없습니다</p>
